...
export default function OwnerChatScreen() {
  ...
  useEffect(() => {
    initChat();
    return () => { supabase.channel(`owner-chat-${matchId}`).unsubscribe(); };
  }, [matchId]);
      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : undefined}>
            ...
            renderItem={({ item }) => {
              ...
              return (
                <View style={{ flexDirection: "row", justifyContent: isMe ? "flex-end" : "flex-start", marginBottom: 6 }}>
                  <View style={{ maxWidth: "75%", backgroundColor: isMe ? Colors.SECONDARY : Colors.SURFACE, borderRadius: 18, borderBottomRightRadius: isMe ? 4 : 18, borderBottomLeftRadius: isMe ? 18 : 4, paddingHorizontal: 14, paddingVertical: 9 }}>
        ...
        <View style={{ flexDirection: "row", alignItems: "flex-end", paddingHorizontal: 12, paddingVertical: 10, borderTopWidth: 1, borderTopColor: Colors.BORDER, backgroundColor: Colors.BACKGROUND, gap: 8 }}>
          ...
          <TouchableOpacity
            ...
            style={{ width: 40, height: 40, borderRadius: 20, backgroundColor: inputText.trim() ? Colors.SECONDARY : Colors.BORDER, alignItems: "center", justifyContent: "center" }}
          >
