      ...
      <View style={{ marginHorizontal: Sizes.SPACING_LG }}>
        ...
        >
          ...
          <Text style={{ color: Colors.TEXT_MUTED, fontSize: 13, lineHeight: 20 }}>
            Füge möglichst viele Fotos und eine detaillierte Beschreibung hinzu — Tiere mit vollständigen
            Profilen werden häufiger geliked!
          </Text>
        </View>
      </View>
    </ScrollView>
...
function StatCard({ value, label, emoji }: { value: number; label: string; emoji: string }) {
  return (
    ...
    >
      ...
      <Text style={{ color: "rgba(255,255,255,0.75)", fontSize: 11, textAlign: "center", marginTop: 2 }}>
        {label}
      </Text>
    </View>
  );
