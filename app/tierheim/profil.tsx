    ...
    <View style={{ flex: 1, backgroundColor: Colors.BACKGROUND }}>
      ...
      <ScrollView contentContainerStyle={{ padding: Sizes.SPACING_LG, paddingBottom: 40 }}>
          ...
          <TouchableOpacity onPress={!isGuest ? handleLogoUpload : undefined} disabled={uploadingLogo} style={{ marginBottom: 14 }}>
            {profile?.logo_url ? (
              ...
              <View style={{ width: 100, height: 100, borderRadius: 50, backgroundColor: Colors.SURFACE, alignItems: "center", justifyContent: "center", borderWidth: 2, borderColor: Colors.BORDER }}>
                <Text style={{ fontSize: 36, fontWeight: "700", color: Colors.TEXT_MUTED }}>
                  {profile?.org_name ? profile.org_name[0].toUpperCase() : "T"}
                </Text>
              </View>
            )}
            {!isGuest && (
        ...
        {profile?.zertifizierungen && (
          <View style={{ marginBottom: 20, padding: 14, backgroundColor: "#FFF9EC", borderRadius: 16 }}>
            <Text style={{ fontSize: 12, fontWeight: "700", color: Colors.TEXT_MUTED, textTransform: "uppercase", letterSpacing: 0.8, marginBottom: 4 }}>Zertifizierungen</Text>
            <Text style={{ fontSize: 14, color: Colors.TEXT, fontWeight: "500" }}>{profile.zertifizierungen}</Text>
          </View>
        )}
