...
export default function HundAnlegenScreen() {
  const { t } = useLanguage();
  ...
  const [modus, setModus]                 = useState<string>("gassidate");
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>🐶 {t.gassi_dogs_register_btn}</Text>
      ...
      >
        ...
        {/* Modus */}
        <Text style={styles.fieldLabel}>{t.gassi_register_label_mode}</Text>
        <View style={styles.pillRow}>
          {MODUS_OPTIONS.map((o) => (
            <Pill
              key={o.key}
              label={o.label}
              selected={modus === o.key}
              onPress={() => setModus(o.key)}
            />
          ))}
        </View>
